    ...
    <div class="row px-xl-5 pb-3">
      <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
        <div class="feature-item text-center border rounded p-4">
          ...
          <h5 class="font-weight-semi-bold mb-0">Producto de Calidad</h5>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
        <div class="feature-item text-center border rounded p-4">
          <h1 class="fa fa-shipping-fast text-primary mb-3"></h1>
          <h5 class="font-weight-semi-bold mb-0">Envío Gratuito</h5>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
        <div class="feature-item text-center border rounded p-4">
          <h1 class="fas fa-exchange-alt text-primary mb-3"></h1>
          <h5 class="font-weight-semi-bold mb-0">Devolución 14 Días</h5>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
        <div class="feature-item text-center border rounded p-4">
          <h1 class="fa fa-phone-volume text-primary mb-3"></h1>
          <h5 class="font-weight-semi-bold mb-0">24/7 Soporte</h5>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row px-xl-5 pb-3">
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                ...
                <h5 class="font-weight-semi-bold m-0 text-center">Nutrition</h5>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                ...
                <h5 class="font-weight-semi-bold m-0 text-center">Proteins</h5>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 pb-1">
            <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                ...
                <h5 class="font-weight-semi-bold m-0 text-center">Vitamins</h5>
            </div>
        </div>
    </div>
</div>
